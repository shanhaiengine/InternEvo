# adapted from https://github.com/InternLM/xtuner/tree/main/xtuner/model/modules/dispatch/triton_kernels/rms_norm.py
...
def _rms_norm_bwd_dx_fused(
    ...
    stride,  # how much to increase the pointer when moving by 1 row
    N,  # number of columns in X
    eps,  # epsilon to avoid division by zero  # pylint: disable=W0613
